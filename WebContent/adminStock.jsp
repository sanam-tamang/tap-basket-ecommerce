	...
	<%@ page
		...
		<body style="background-color: #E6F9E6;">
			<% /* Checking the user credentials */ String userType=(String) session.getAttribute("usertype"); String
				...
				<div class="text-center" style="color: green; font-size: 24px; font-weight: bold;">Stock
					Products</div>
					...
					<div class="table-responsive ">
						<table class="table table-hover table-sm">
							...
							<tbody style="background-color: white; font-size: 16px;">
								...
								<% ProductServiceImpl productDao=new ProductServiceImpl(); List<ProductBean> products =
									new ArrayList<ProductBean>();
										...
										<tr>
											...
											<% String name=product.getProdName(); name=name.substring(0,
												...
												<td>
													<%=new OrderServiceImpl().countSoldItem(product.getProdId())%>
												</td>
												<td>
